...
function resolveUrl(url) {
	if (url.startsWith('http://') || url.startsWith('https://')) {
		// Convert standard YouTube URLs to ultra-aggressive ad-blocking embed URLs
		if (url.includes('youtube.com/watch?v=') || url.includes('youtu.be/') || url.includes('youtube.com/embed/')) {
			...
			if (videoId) {
				// We use a combination of nocookie, small video quality, and origin override.
				// The "origin" parameter is specifically set to youtube.com to bypass certain checks.
